...
function scoreChunk(question,chunk) {
  ...
  const phrases=[
    ...
    ['교원 휴가',18],['휴가',12],['연가',12],['병가',14],['공가',12],['특별휴가',14],['경조사휴가',14],['가족돌봄휴가',14],['육아시간',14],['임신검진 동행휴가',16],['장기재직휴가',28],['장기재직',24],
    ['교외체험학습',14],['생활기록부',14],['수행평가',12],['평가계획',12],['웨일북',14],['웨일스페이스',12],
    ['출장',10],['결재',10],['결석',10],['출결',10],['스마트기기',10],['전보',12],['학적',10]
  ];
